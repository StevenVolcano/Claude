...
- **Self-hosted and community-owned.** Runs on a small VPS (~$5–15/month total).
  If a hosted commercial tool dies, its users' data dies with it; Ghostlight's doesn't.
...
**Ghostlight** — the single light left burning on every empty stage: the theater is
still alive between shows. Known to every theater person, warm and meaningless-in-a-
good-way to newcomers. Local identity lives in the tagline, not the name:
*"Ghostlight — Grays Harbor's theater community."*

(Runners-up considered: The Callboard — most literal but a crowded namespace
[callboards.app, callboard.app, VirtualCallboard]; Prompt Book — perfect "master
binder" metaphor but "prompt" now reads AI-ish to some; Places!; Green Room.)
...
- **Repository**: Ghostlight should live in its own dedicated repo; this document lives
...
- Lighting master / lighting & sound **cue sheets — paperwork only**; QLab owns cue
  execution and Ghostlight stays out of that lane.
...
- Standard MTI / Concord / Dramatic Publishing terms prohibit scanning or reproducing
  rented and purchased materials. Ghostlight does not become a script locker.
...
- For MTI musicals the honest path is the **$199 ProductionPro add-on** to the show
  ...
  to the licensed script; Ghostlight handles everything else.
- Where Ghostlight's annotation layer fully shines: original works, owned-rights
...
1. **Record-a-part** (the flagship): each cast member records their own lines on their
   phone; Ghostlight assembles the full-cast audio track; you rehearse against your
   ...
   — Ghostlight already has the whole cast in one production space.
...
management project exists** — Ghostlight would be first of its kind in the niche.
